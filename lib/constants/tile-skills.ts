...
// Offer Sender Skills
const OFFER_SENDER_SKILLS: DefaultTileSkill[] = [
  {
    id: "offer-professional-business",
    name: "Professional Business Offer",
    description:
      "Polish the offer with professional sales tone, editorial cleanup, and correct grammar",
    category: "custom",
    tileType: "offer_sender",
    prompt: `You are a senior sales copywriter and editor preparing a business offer email. Apply these standards when personalizing the template:
...
export const DEFAULT_TILE_SKILLS: Record<TileType, DefaultTileSkill[]> = {
  ...
  knowledge_base: [],
  offer_sender: OFFER_SENDER_SKILLS,
};
