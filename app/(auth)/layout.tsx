...
export default function AuthLayout({
  ...
  return (
    <div className="min-h-screen bg-slate-950 relative overflow-hidden flex flex-col items-center pt-[6vh] md:pt-[10vh]">
      ...
      <div className="relative z-10 w-full max-w-xl px-4 flex flex-col">
        <div className="flex items-center justify-between mb-8 w-full">
          ...
          >
            <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-emerald-500/10 border border-emerald-500/20 group-hover:border-emerald-500/40 transition-colors">
          ...
          <Link
            href="/"
            className="flex items-center gap-1 text-xs font-bold text-slate-500 hover:text-emerald-400 uppercase tracking-widest transition-colors group"
          >
